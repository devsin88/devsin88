					...
					<div class="col-md-6 col-md-offset-3">
						<div class="footer-content text-center padding-ver-clear">
							...
							<ul class="list-inline mb-20">
								...
								<li><i class="text-default fa fa-envelope-o pl-10 pr-5"></i>sinseonghwan@hanmail.net</li>
							</ul>
...
<!-- 								<li class="facebook"><a target="_blank"
								...
								<li class="linkedin"><a target="_blank"
									href="http://devsin88.tistory.com"><i class="fa fa-link"></i></a></li>
								<li class="xing"><a target="_blank"
									href="https://github.com/devsin88/devsin88"><i class="fa fa-github"></i></a></li>
							</ul>
							<div class="separator"></div>
							<p class="text-center margin-clear">
								Copyright © 2017 The Project by devsin88.
							</p>
						</div>
					</div>
				</div>
